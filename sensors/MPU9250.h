...
class MPU9250{
  public:
    ...
    void readRawAccel(Vector<int16_t> *accelRaw);
    void readRawGyro(Vector<int16_t> *gyroRaw);
    void readCalcAccel(Vector<int16_t> *accelRaw);
    float getAccelX_mss();
    float getAccelY_mss();
    float getAccelZ_mss();
    float getGyroX_rads();
...
public:
    int readBaroReg(uint8_t subAddress, uint8_t count, uint8_t* dest);
