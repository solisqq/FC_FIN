...
void Output::printLine(int toPrint, int prec=3){Serial.println(toPrint);}
void Output::printLine(float toPrint, int prec=3){
    Serial.print(toPrint, prec);
    Serial.println("");
}
void Output::printLine(double toPrint, int prec=3){
    Serial.print(toPrint, prec);
    Serial.println("");
}
...
void Output::Append(float toPrint, String valueName = "", int prec=3){
...
void Output::Append(double toPrint, String valueName = "",int prec=3){
    String converted = static_cast<String>(toPrint);
    int index = converted.indexOf(".");
    converted = converted.substring(0,index+prec);
    if(valueName=="") 
